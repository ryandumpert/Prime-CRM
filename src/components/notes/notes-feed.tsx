...
export function NotesFeed({
    ...
    if (notes.length === 0) {
        return (
            <div className={`text-center text-gray-600 ${compact ? 'py-3' : 'py-6'}`}>
                <FileText className={`mx-auto mb-2 opacity-40 ${compact ? 'w-6 h-6' : 'w-8 h-8'}`} />
                ...
                return (
                    <div
                        ...
                        className={`group rounded-lg border transition-colors ${isPinned
                                ...
                                : 'border-[hsl(222,47%,18%)] bg-[hsl(222,47%,10%)]'
                            } ${compact ? 'p-3' : 'p-4'}`}
                    >
                        {/* Header */}
                        ...
                        {/* Body */}
                        <p className={`text-gray-300 whitespace-pre-wrap break-words ${compact ? 'text-sm leading-relaxed' : 'text-sm leading-relaxed'
                            }`}>
